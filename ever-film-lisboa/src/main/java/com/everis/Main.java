...
public class Main {
	...
	public static void main(String[] args) {
		...
		Actor billy = new Actor("Billy", "Zane", 53, TipoActor.SUPPORTING);
		Actor tom = new Actor("Tom", "Cruise", 54, TipoActor.SUPPORTING);
		Actor amy = new Actor("Amy", "Adams", 34, TipoActor.MAIN);
		...
		User user1 = new User("Joao", "Rafael", 23, ratingsUser1, Arrays.asList(film1, film2, film3, film4, film5),
				"JRafa");
